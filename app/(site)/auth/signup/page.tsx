    ...
    <>
      <section className="pt-32.5 lg:pt-45 xl:pt-50 pb-12.5 lg:pb-25 xl:pb-30">
        <div className="mx-auto max-w-c-1016 relative z-1 pt-10 lg:pt-15 xl:pt-20 pb-7.5 px-7.5 lg:px-15 xl:px-20">
          ...
          >
            <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle2 font-semibold mb-15 text-center">Create an Account</h2>
            ...
            <div className="mb-10 flex items-center justify-center">
              ...
              <p className="w-full px-5 text-center text-base text-body-color dark:text-body-color-dark">Or, register with your email</p>
              <span className="hidden h-[1px] w-full max-w-[200px] bg-stroke dark:bg-stroke-dark sm:block"></span>
            </div>
            ...
            <form>
              ...
              <div className="text-center border-t border-stroke dark:border-strokedark mt-12.5 py-5">
                <p>
                  ...
                  <Link className="text-black dark:text-white hover:text-primary dark:hover:text-primary" href="/auth/signin">
                    Sign In
                  </Link>
                </p>
              </div>
